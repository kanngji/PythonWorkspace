...
#화면 타이틀 설정
pygame.display.set_caption("FREIND GAME") #게임이름
...
#배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\강지훈\\Desktop\\PythonWorkspace\\pygame\\background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\강지훈\\Desktop\\PythonWorkspace\\pygame\\character.png")
...
#적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\강지훈\\Desktop\\PythonWorkspace\\pygame\\enemy.png")
